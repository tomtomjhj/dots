...
hi Keyword         guifg=#f0dfaf gui=bold                     ctermfg=217 cterm=bold
...
"hi Structure       guifg=#efefaf gui=bold                     ctermfg=217 cterm=bold
...
"hi Type            guifg=#00ffff gui=bold                     ctermfg=153 cterm=bold
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi Normal        guifg=#dcdccc guibg=#1f1f1f           ctermfg=255 ctermbg=234
